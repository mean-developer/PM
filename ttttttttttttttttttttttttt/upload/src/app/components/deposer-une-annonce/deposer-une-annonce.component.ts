...
@Component({
  selector: 'app-deposer-une-annonce',
  templateUrl: './deposer-une-annonce.component.html',
  styleUrls: ['./deposer-une-annonce.component.css']
})
export class DeposerUneAnnonceComponent implements OnInit {
